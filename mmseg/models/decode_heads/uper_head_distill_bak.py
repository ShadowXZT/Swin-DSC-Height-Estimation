...
class UPerHead(BaseDecodeHead):
    ...
    def __init__(self, pool_scales=(1, 2, 3, 6), **kwargs):
        ...
        self.distill_bottleneck = ConvModule(
            len(self.in_channels) * self.channels,
            self.unit_clusters,
            3,
            padding=1,
    ...
    def forward(self, inputs):
        ...
        distill_output = self.distill_bottleneck(fpn_outs) #N, 16, h, w
        '''
        for i in range(16):
            ...
            cv2.imwrite('/home/xshadow/Swin-Transformer-Semantic-Segmentation/response_new/mean_response_' + str(i) + '.png', simage)
        ...
        return output
        #return output, ori_output, distill_output
